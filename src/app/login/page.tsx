...
//   const { user, loading, signInWithGoogle, signInWithGithub, signInWithEmail } =
//     useAuth();
...
//           ),
//           generateImageAction(
//             "serene nature sunrise, minimalist, digital painting"
//           ),
//         ]);
...
//             <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between text-xs mt-2 gap-2 sm:gap-0">
...
//               variant="outline"
//               className="w-full sm:w-1/2 bg-transparent border-gray-300 text-gray-700 hover:bg-gray-50 hover:border-gray-400 flex items-center justify-center gap-2"
//             >
